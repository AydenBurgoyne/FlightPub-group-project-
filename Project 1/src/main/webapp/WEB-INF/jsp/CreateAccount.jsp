<%@ page import="me.groupFour.data.Review" %>
...
<body class="text-center">
    ...
    <div class="container">
        ...
        <form:form action="/Account/ValidateAccCreation" method="post" modelAttribute="AccountEntity">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <form:input class="form-control" path="dummyWishList"/> <br/>
